...
Python wrapper for Arkansas school enrollment data.

This is a thin rpy2 wrapper around the [arschooldata](https://github.com/almartin82/arschooldata) R package. It provides the same functionality but returns pandas DataFrames.

## Requirements

- Python 3.9+
- R 4.0+
- The `arschooldata` R package installed
